...
const MugProduct = ({ product, data, setData, stageRef, onAddToCart }) => {
          ...
          >
            {activeTab === "real" ? (
              ...
              <div className="w-100 text-center">
                ...
                />
                {/* Chỉ hiển thị danh sách ảnh nhỏ nếu có nhiều ảnh */}
